...
import { OuvragesHydrauliques, OuvragesHydrauliquesData } from '../../../models/ouvrageshydrauliques.model';
import { OuvrageshydrauliquesService } from '../../../services/ouvrageshydrauliques.service';
import { DonnesTroconsService } from '../../../services/donnes-trocons.service';
import { DonneTrocons } from '../../../models/donne-trocons.model';
...
export class AddEditProjetComponent {
  ...
  onNavigateToCalendar(){
    this.router.navigate(['/Calendar',this.projetId]);
  }
